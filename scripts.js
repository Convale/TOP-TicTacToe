...
//this function is terribly written: manually set and should ultimately be condensed to an interative function. It's 72 lines!!!!
function checkWin() {
    const currentPlayerIcon = (currentPlayer == 1) ? "X" : "O";
    if (gameValues[0] == currentPlayerIcon && gameValues[1] == currentPlayerIcon && gameValues[2] == currentPlayerIcon) {
    ...
    else if (gameValues[3] == currentPlayerIcon && gameValues[4] == currentPlayerIcon && gameValues[5] == currentPlayerIcon)  {
    ...
    else if (gameValues[6] == currentPlayerIcon && gameValues[7] == currentPlayerIcon && gameValues[8] == currentPlayerIcon) {
    ...
    else if (gameValues[0] == currentPlayerIcon && gameValues[3] == currentPlayerIcon && gameValues[6] == currentPlayerIcon) {
        document.getElementById('0').style.backgroundColor = 'rgb(149, 186, 147)';
        document.getElementById('3').style.backgroundColor = 'rgb(149, 186, 147)';
        document.getElementById('6').style.backgroundColor = 'rgb(149, 186, 147)';
        (currentPlayer == 1) ? player1.incrementWin() : player2.incrementWin();
    ...
    else if (gameValues[1] == currentPlayerIcon && gameValues[4] == currentPlayerIcon && gameValues[7] == currentPlayerIcon) {
        document.getElementById('1').style.backgroundColor = 'rgb(149, 186, 147)';
        document.getElementById('4').style.backgroundColor = 'rgb(149, 186, 147)';
        document.getElementById('7').style.backgroundColor = 'rgb(149, 186, 147)';
        (currentPlayer == 1) ? player1.incrementWin() : player2.incrementWin();
    ...
    else if (gameValues[2] == currentPlayerIcon && gameValues[5] == currentPlayerIcon && gameValues[8] == currentPlayerIcon) {
        document.getElementById('2').style.backgroundColor = 'rgb(149, 186, 147)';
        document.getElementById('5').style.backgroundColor = 'rgb(149, 186, 147)';
        document.getElementById('8').style.backgroundColor = 'rgb(149, 186, 147)';
        (currentPlayer == 1) ? player1.incrementWin() : player2.incrementWin();
    ...
    else if (gameValues[0] == currentPlayerIcon && gameValues[4] == currentPlayerIcon && gameValues[8] == currentPlayerIcon) {
        document.getElementById('0').style.backgroundColor = 'rgb(149, 186, 147)';
        document.getElementById('4').style.backgroundColor = 'rgb(149, 186, 147)';
        document.getElementById('8').style.backgroundColor = 'rgb(149, 186, 147)';
        (currentPlayer == 1) ? player1.incrementWin() : player2.incrementWin();
    ...
    else if (gameValues[2] == currentPlayerIcon && gameValues[4] == currentPlayerIcon && gameValues[6] == currentPlayerIcon) {
        document.getElementById('2').style.backgroundColor = 'rgb(149, 186, 147)';
        document.getElementById('4').style.backgroundColor = 'rgb(149, 186, 147)';
        document.getElementById('6').style.backgroundColor = 'rgb(149, 186, 147)';
        (currentPlayer == 1) ? player1.incrementWin() : player2.incrementWin();
    ...
    else if (gameValues[0] != "" && gameValues[1] != "" && gameValues[2] != "" && gameValues[3] != "" && gameValues[4] 
...
function playerWinsBanner() {
    gameArray = document.querySelector('#player1').innerHTML = "Player 1: " + player1.wins;
    gameArray = document.querySelector('#player2').innerHTML = "Player 2: " + player2.wins;
}
